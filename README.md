# Candles Arduino Project

Connect two LEDS on port 3 and 5 to get candle light flicker effect.

The project is completely autogenerated with Copilot. Only the flicker-parameters have been adapted and a FACTOR is introduced to scale the timing.
